...
public class CommandSetMisc extends CommandBase
{
	...
	public void processCommand(ICommandSender icommandsender, String[] astring) 
	{
		...
		if (astring.length >= 1)
		{
			...
			{
				RCM.instance.skillHandler.resetAllExperienceAndLevels();
	...
	public List addTabCompletionOptions(ICommandSender par1iCommandSender, String[] astring) 
	{
		if (astring.length == 1)
		{
			return getListOfStringsMatchingLastWord(astring, new String[] { "maxplayer", "ultramaxplayer", "resetplayer", "maxpouchcash" });
		}
		return null;
	}
}