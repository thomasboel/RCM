...
public class GUISeedBag extends GuiContainer
{
	 ...
	 */
	private static final ResourceLocation iconLocation = new ResourceLocation(Reference.MOD_ID, "textures/gui/seedbaginventory.png");

	/** The inventory to render on screen */
	private final InventorySeedBag inventory;

	public GUISeedBag(ContainerSeedBag containerItem)
	{
		super(containerItem);
