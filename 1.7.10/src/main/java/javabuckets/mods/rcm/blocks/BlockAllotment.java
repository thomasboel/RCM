...
public class BlockAllotment extends BlockBush implements IGrowable
{
    @SideOnly(Side.CLIENT)
    private IIcon[] icon;

    private Item allotmentSeed;

	private Item allotmentToDrop;
    
    public BlockAllotment(Item correspondingHerbSeed)
    {
        ...
        this.disableStats();
        this.allotmentSeed = correspondingHerbSeed;
    }
    ...
    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
    	if (p_149650_1_ == 3)
    	{
    		if (this == ModFarmingBlocks.onions) return ModFarmingItems.onion;
    		else if (this == ModFarmingBlocks.cabbage) return ModFarmingItems.cabbage;
    		else if (this == ModFarmingBlocks.tomatoes) return ModFarmingItems.tomato;
    		else if (this == ModFarmingBlocks.sweetcorn) return ModFarmingItems.sweetcorn;
    		else if (this == ModFarmingBlocks.strawberries) return ModFarmingItems.strawberry;
    		else if (this == ModFarmingBlocks.snapegrass) return ModHerbloreItems.snape_grass;
    		else return null;
    	}
    	else
    	{
