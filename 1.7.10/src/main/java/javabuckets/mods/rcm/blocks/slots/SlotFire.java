...
public class SlotFire extends Slot
{
    /** The player that is using the GUI where this slot resides. */
    private EntityPlayer thePlayer;
    private int field_75228_b;

    public SlotFire(EntityPlayer p_i1813_1_, IInventory p_i1813_2_, int p_i1813_3_, int p_i1813_4_, int p_i1813_5_)
    {
    ...
    protected void onCrafting(ItemStack itemstack)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float f = CookingRecipes.cooking().func_151398_b(itemstack);
            int j;
            ...
            RCM.instance.skillHandler.addXPToSkill(SkillReference.cook, 25 * itemstack.stackSize);
        }
