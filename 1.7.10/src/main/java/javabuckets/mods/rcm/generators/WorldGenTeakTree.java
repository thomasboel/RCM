...
public class WorldGenTeakTree extends WorldGenAbstractTree
{
	private int treeHeight = 10;

	public WorldGenTeakTree() 
	{
		super(false);
	}
	...
	{
		world.setBlock(x, y, z, ModWoodcuttingBlocks.teakLog);
	}

	public void buildLeavesAt(World world, int x, int y, int z)
	{
		world.setBlock(x, y + treeHeight, z, ModWoodcuttingBlocks.teakLeaves);
	}
}