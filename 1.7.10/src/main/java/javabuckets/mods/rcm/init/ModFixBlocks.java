...
public class ModFixBlocks 
{
	...
	public static void init()
	{
		...
		oakLog = new BlockFixLog().setHardness(2.0F).setBlockTextureName("oak_log");
		GameRegistry.registerBlock(oakLog, "oak_log");
		
		spruceLog = new BlockFixLog().setHardness(2.0F).setBlockTextureName("spruce_log");
		GameRegistry.registerBlock(spruceLog, "spruce_log");
		
		birchLog = new BlockFixLog().setHardness(2.0F).setBlockTextureName("birch_log");
		GameRegistry.registerBlock(birchLog, "birch_log");
		
		jungleLog = new BlockFixLog().setHardness(2.0F).setBlockTextureName("jungle_log");
		GameRegistry.registerBlock(jungleLog, "jungle_log");
		
		acaciaLog = new BlockFixLog().setHardness(2.0F).setBlockTextureName("acacia_log");
		GameRegistry.registerBlock(acaciaLog, "acacia_log");
		
		darkOakLog = new BlockFixLog().setHardness(2.0F).setBlockTextureName("dark_oak_log");
