...
public class EntityMagicBolt extends Entity implements IProjectile
{
	/** The attacker (the player) */
	...
	public EntityMagicBolt(World world, EntityLivingBase entity, float velocity, double damage)
	{
		super(world);
		...
		this.setDamage((double)rand.nextInt((int)damage));
        ...
        if (movingobjectposition != null)
        {
            if (movingobjectposition.entityHit != null)
            {
                ...
                if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)k))
                {
                    ...
                    this.playSound("fire.ignite", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
                }
                else
                {
                ...
                {
                	elb.addPotionEffect(new PotionEffect(Potion.confusion.id, 1200, 1, false));
                }
                if (RCM.instance.magic.getCurrentSelectedSpell() == MagicReference.weaken)
                {
                	elb.addPotionEffect(new PotionEffect(Potion.weakness.id, 1200, 1, false));
                }
    ...
    /**
     * Sets the amount of knockback the magic bolt applies when it hits a mob.
     */
    ...
    /**
     * Whether the magic bolt has a stream of critical hit particles flying behind it.
     */
