...
public class ItemWeaponBase extends ItemBase
{
    ...
    private float strengthDamage = RCM.instance.skillHandler.getLevel(SkillReference.str) * 0.4F;
    private final Item.ToolMaterial toolMaterial;

    public ItemWeaponBase(String unlocalizedName, Item.ToolMaterial toolMaterial)
    {
        ...
        this.weaponDamage = 4.0F + toolMaterial.getDamageVsEntity() + strengthDamage;
    }
